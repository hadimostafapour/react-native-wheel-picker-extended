...
public class ReactWheelCurvedPicker extends WheelCurvedPicker {
    ...
    public void setFontFamily(ReactContext reactContext, String fontFamily){

        String fontName = new StringBuilder()
                .append("fonts/")
                .append(fontFamily)
                .append(".ttf")
                .toString();
        ...
        try {
            Typeface regular = Typeface.createFromAsset(reactContext.getAssets(), fontName);
            this.mTextPaint.setTypeface(regular);
    ...
    protected void drawForeground(Canvas canvas) {
        ...
        int colorFrom = this.lineColor;//Color.BLACK;
        int colorTo = this.lineColor;
